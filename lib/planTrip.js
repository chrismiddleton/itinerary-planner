...
function planTrip() {
	...
	while (currentSpot.time < departureSpot.time && placeNames.length > 0) {
		...
		// TODO: Default to different stay depending on kind of attraction (town vs movie vs restaurant vs castle etc)
		// TODO: Allow the user to resize their stay at a particular attraction after generating trip
